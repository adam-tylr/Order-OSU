...
class OperationDetailsViewController: UIViewController {
    ...
    func loadDetails(){
        ...
        let padDetails = OperationDetails(photo: photo2, msg: "Order Online for Pickup or Delivery (Additional 30 minutes needed for delivery) Example: If you select a 530pm time slot and choose delivery, your order will arrive at 6PM. The PAD is located inside Lawrence Tower", hours: "PAD Delivers Sunday-Saturday 4pm - 12am")!
